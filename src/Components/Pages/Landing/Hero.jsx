    ...
    <div className="relative h-screen w-full">
      ...
      <div className="absolute inset-0">
        <img
          ...
          className="w-full h-[80vh] object-cover mx-auto --mt-10"
        />
        {/* Overlay */}
      ...
      <div className="ml-14 relative z-10 max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col justify-center h-full max-w-2xl">
          {/* Heading */}
          <h1 className="text-7xl font-bold text-gray-800 mb-6 mt-28">
            <span>Secure </span>
          ...
          <p className="text-2xl   mb-4">
            Discover tailored insurance solutions for pensions <br /> and
            personal accidents that protect you and your <br /> loved ones,
            ensuring peace of mind for a brighter <br /> tomorrow.
          </p>
